...
export function DashboardPage() {
  ...
  return (
    <>
      <header className="flex h-[64px] items-center justify-between border-b border-gray-200 bg-white px-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-purple-200 bg-purple-50 px-3 py-2 text-sm font-semibold text-purple-700 transition-colors hover:bg-purple-100"
          >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-64 rounded-lg border border-gray-200 bg-white py-2 pl-9 pr-4 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
            />
          </div>
          <button className="relative rounded-lg p-2 transition-colors hover:bg-gray-100" title="提醒">
      ...
      <main className="space-y-5 overflow-y-auto px-6 pb-6 scrollbar-thin">
