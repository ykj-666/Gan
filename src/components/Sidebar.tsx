...
export function SidebarBrand({ compact = false }: { compact?: boolean }) {
  return (
    <div className={compact ? "px-4 pb-4 pt-4" : "px-5 pb-5 pt-6"}>
...
export function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-[240px] flex-col border-r border-gray-800 bg-gray-900 md:flex">
      <SidebarBrand />
      <SidebarNav />
      <SidebarUserCard />
    </aside>
